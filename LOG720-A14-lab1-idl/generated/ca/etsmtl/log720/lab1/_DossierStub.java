	...
	implements ca.etsmtl.log720.lab1.Dossier
{
	...
	public void ajouterInfractionAListe(int idInfraction)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				_os = _request( "ajouterInfractionAListe", true);
	...
	public java.lang.String noPlaque()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				_os = _request("_get_noPlaque",true);
				_is = _invoke(_os);
	...
	public int[] getListeInfraction()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				_os = _request( "getListeInfraction", true);
				_is = _invoke(_os);
	...
	public void ajouterReactionAListe(int idReaction)
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				_os = _request( "ajouterReactionAListe", true);
	...
	public int[] getListeReaction()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				_os = _request( "getListeReaction", true);
				_is = _invoke(_os);
	...
	public java.lang.String noPermis()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				_os = _request("_get_noPermis",true);
				_is = _invoke(_os);
				return _is.read_string();
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
