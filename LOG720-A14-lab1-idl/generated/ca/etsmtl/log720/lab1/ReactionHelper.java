...
public final class ReactionHelper
{
	...
	{
		return narrow(in.read_Object(ca.etsmtl.log720.lab1._ReactionStub.class));
	}
	...
	public static ca.etsmtl.log720.lab1.Reaction narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof ca.etsmtl.log720.lab1.Reaction)
		{
			return (ca.etsmtl.log720.lab1.Reaction)obj;
		}
		else if (obj._is_a("IDL:ca/etsmtl/log720/lab1/Reaction:1.0"))
		{
